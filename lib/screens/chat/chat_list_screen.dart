...
class _ChatListScreenState extends ConsumerState<ChatListScreen> {
  ...
  void initState() {
    super.initState();
    // FIX: Join presence immediately on tab open, not only when user changes.
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    ...
    // Re-join if auth changes mid-session
...
class _ActiveUsersBar extends StatelessWidget {
  ...
  const _ActiveUsersBar({required this.rooms, required this.currentUserId, required this.onlineIds});
                  ...
                  Container(
                    ...
                    child: Padding(padding: const EdgeInsets.all(2),
                      child: CircleAvatar(
                        ...
                        child: Text(room.displayInitial(currentUserId),
                            style: GoogleFonts.poppins(color: color, fontWeight: FontWeight.w700, fontSize: 18)),
                      )),
                  ),
...
class _RoomTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.92), borderRadius: BorderRadius.circular(14),
      ...
      child: ListTile(
        ...
        leading: Stack(clipBehavior: Clip.none, children: [
          CircleAvatar(backgroundColor: c.withOpacity(0.15),
